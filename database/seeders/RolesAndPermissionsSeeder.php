...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $arrayOfPermissionNames = [
          ...
          'view-items','create-item','view-outstock-items','view-expired-items','view-item-price',
          'view-items-settings','manage-item-units','manage-item-groups','manage-item-categories','manage-item-price-type',
